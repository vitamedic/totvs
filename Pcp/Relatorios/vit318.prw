...
While qz1->qz1_prod == _cprod .and. lOk
	...
	If cTipo == "OP" .and. cDocC == "N" .and. cObso == "N"//Marcio David - 07/01/2019 Acrescentando .and. cDocC <> "S" para tratar documento cancelado // Guilherme Teodoro - 19/05/2016 - Melhoria para contemplar outros tipos de documentos - Projeto P.I.
		lOk := .f.
