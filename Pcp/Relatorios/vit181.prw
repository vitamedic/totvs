...
nomeprog :="VIT181"
wnrel    :="VIT181"+Alltrim(cusername)
alinha   :={}
nlastkey :=0
cbcont   :=0
m_pag    :=1
...
// Acrescentamos o parametro do RT para analise do custo do itens por RT.
/*      if _locpad =="03"
			sz0->(dbseek(_cfilsz0+_cproduto+_locpad+_lote))
			_mresp:= if(empty(sz0->z0_resp),"PATRICIA",substr(sz0->z0_resp,1,10))
			if mv_par11==2
				_mtpr :="P"
			elseif mv_par11=3
				_mtpr :="R"		
		...
		if _mtpr == substr(_mresp,1,1) .or. _mtpr ="T"*/
			@ prow()+1,000 PSAY _lote 
			@ prow(),011   PSAY _locpad         	
			@ prow(),016   PSAY _nqlote  picture "@E 99,999,999.99"
			@ prow(),034   PSAY _nqemplote-_empop picture "@E 999,999,999.99"
...
//			@ prow(),096   PSAY _mresp			
//			@ prow(),110   PSAY (_nqemplote-_empop)*_npreco picture "@E 999,999,999.99"			
//		endif	
	end
	if lcontinua
		@ prow()+1,000 PSAY "TOTAIS:"
		@ prow(),016   PSAY _nquant  picture "@E 99,999,999.99"
   	@ prow(),034   PSAY _nempenho-_empop picture "@E 999,999,999.99"
...
aadd(_agrpsx1,{cperg,"11","RT                 ?","mv_chB","N",01,0,0,"C",space(60),"mv_par11"       ,"1-Todos     "   ,space(30),space(15),"2-Patricia     ",space(30),space(15),"3-Ricardo      ",space(30),space(15),"4-Silvestre    ",space(30),space(15),space(15)        ,space(30),"   "})
