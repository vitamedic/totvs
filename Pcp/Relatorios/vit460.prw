...
/*/{Protheus.doc} vit318
//ORDEM DE PESAGEM DE MATÉRIA-PRIMA E SEPARACAO DE MATERIAL DE EMBALAGEM EM ORDEM DE PRODUCAO - HTML
...
If nRadio <> 2 // Imprime o Documento de Tecnica de Fabricação
	If (qdh->(!Eof()) .and. qdh->qdh_filial + qdh->qdh_docto == _cFilDoc) .and.;
		...
		OLE_SetDocumentVar( oWord, "Adv_TipoOP","ORDEM DE EMBALAGEM")     //Guilherme Teodoro - Para emissão do O.E.
...
if _mfirst
	...
	_cMsg3 += '<title>FICHA PESAGEM MP E SEPARA&Ccedil;&Atilde;O DE ME</title>'
...
_cMsg3 += '<td width="141" rowspan="5" class="style2"><p align="center"><img width="106" height="29" src="http://10.1.1.27/laudo0101.png" align="left" hspace="12" alt="logo.jpg" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p></td>' //Guilherme 21/08/15//Para que o endereço seja reolvido pelo named.
