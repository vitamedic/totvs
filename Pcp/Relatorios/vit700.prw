...
±±³Programa  ³ VIT700   ³ Autor ³ Henrique Correia/Totvs³ Data ³ 24/08/17 ³±±
...
if cArC2_D1 == 'SC2'
	//adequaÃ§Ã£o Ã  emissÃ£o da etiqueta para Lote 006984 (gerado na virada do mÃªs). 01/06/2006.
...
if ! sc2->(dbseek(_cfilsc2+_cop))
	//msgstop("OP nÃ£o encontrada!")
	_lok:=.f.
	cArC2_D1 := ''
	if MsgYesNo("OP não encontrada. Deseja pesquisar em documentos de entrada?", "A t e n ç ã o")
		dbSelectArea("SD1")
