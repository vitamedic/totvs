...
±±³Programa  ³ VIT307   ³Autor ³ Alex Junio de Miranda  ³Data ³ 01/03/08  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³ Grava o Gerenciamento de Previsao de Vendas - Gerado na    ³±±
±±³          ³ Tabela SZR Atraves de Procedure                            ³±±
...
user function vit307()
cperg:="PERGVIT307"
_pergsx1()
if pergunte(cperg,.t.) .and.;
	msgyesno("Confirma a Gravacao do Gerenciamento de Previsao de Vendas?")
	
	processa({|| _calcgravpv()})
	
endif
return()

static function _calcgravpv()
_cfilszr:=xfilial("SZR")

procregua(1)

incproc("Executando Procedure para Gravacao...")
