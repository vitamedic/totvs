...
cabec1:="    Função                      Nome                                 SalárioBase  Adicionais  Salário   Comissão  Sub-Total Encargos(1)   FGTS(2)  Sub-Total      Vale Tr.   Refeição     Unimed     Total"
...
while ! tmp1->(eof()) .and.;
	...
	while ! tmp1->(eof()) .and.;
		...
		//		srd->(dbseek(_cfilsrd+_cc+tmp1->mat+mv_par08+"714"+"   "))  // 13º
		//		_sal1+=srd->rd_valor
