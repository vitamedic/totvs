#IFDEF SPANISH                   
         ...
         #define STR0002  "que estan en el archivo y que aun no fueron impresos "
         ...
         #define STR0037  "TEL:  "
         #define STR0038  "FAX:  "
         #define STR0039  "Nº.Contrib.: "
         #define STR0040  "Nº.Contrib.: "
         #define STR0041  "IE :"
         #define STR0042  "TEL.: "
         #define STR0043  "Itm|"
		 ...
		 #define STR0055  "|Valor Unitario|IVA|  Valor Total   | Entrega  | S.C. |"
         #define STR0056  "|Valor Unitario|      Valor Total   | Entrega  |  CCOSTO | S.C. |"
         #define STR0057  "|Valor Unitario|      Valor Total   | Entrega  | S.C. |"
...
#ELSE
   #IFDEF ENGLISH
         ...
         #define STR0055  "|Unit Valie    |IPI|  Total Value   |  Deliv.  | P.R. |"
         #define STR0056  "|Unit Value    |      Total Value   |  Deliv.  |  C.C.   | P.R. |"
         #define STR0057  "|Unit Value    |      Total Value   |  Deliv.  | P.R. |"
   ...
   #ELSE
         ...
         #define STR0002  "cadastradados e que ainda nao foram impressos"
         ...
         #define STR0029  "|   NOTA: So aceitaremos a mercadoria se na sua Nota Fiscal constar o numero da Autorizacao de Entrega."
         #define STR0030  "Continua ..."
         #define STR0031  "| P E D I D O  D E  C O M P R A S"
         #define STR0032  "| A U T.   D E   E N T R E G A   "
         ...
         #define STR0046  "|UM|  Quant."
         #define STR0047  "|Valor Unitario|IPI |  Valor Total |Entrega |Lead Time| OBS/C.C | S.C. |"
         #define STR0048  "|Valor Unitario|    Valor Total    |Entrega | Numero da OP  "
         ...
         #define STR0054  "Aprovador(es) :"
		   #define STR0055  "|Valor Unitario|IPI |  Valor Total |Entrega |Lead Time| S.C.           |"
         #define STR0056  "|Valor Unitario|       Valor Total |Entrega |Lead Time| OBS/C.C | S.C. |"
		   #define STR0057  "|Valor Unitario|       Valor Total |Entrega |Lead Time| S.C.           |"
