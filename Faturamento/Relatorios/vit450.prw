...
±±³Programa  ³ VIT450   ³ Autor ³ Guilherme Teodoro     ³ Data ³ 13/05/16 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³ Resumo da Movimentacao do Estoque de PN                    ³±±
...
user function vit450()
nordem   :=""
tamanho  :="M"
limite   :=132
titulo   :="RESUMO DA MOVIMENTACAO DO ESTOQUE DE PN"
cdesc1   :="Este programa ira emitir o resumo da movimentacao do estoque de PN"
cdesc2   :=""
cdesc3   :=""
cstring  :="SB1"
areturn  :={"Zebrado",1,"Administracao",2,2,1,"",1}
nomeprog :="VIT450"
wnrel    :="VIT450"+Alltrim(cusername)
