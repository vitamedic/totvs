...
±±³Programa  ³ VITQ013    ³Autor ³ Gardenia              ³Data ³ 24/10/03 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³ Protocolo de Recolhimento de Documentos                    ³±±
...
user function VITQ013()
nordem   :=""
tamanho  :="M"
limite   :=132
titulo   :="PROTOCOLO DE RECOLHIMENTO DE  DOCUMENTOS"
...
while ! tmp1->(eof()) .and.;
	...
	if prow()==0 .or. prow()>54
		...
		@ prow()+2,00 PSAY  "USUARIO/PASTA                                       COP. TIPO        RECOLHIDO            DATA           OBS."	
		_cdocto:=tmp1->docto
	endif                            
	incregua()
	...
	while ! tmp2->(eof())
		...
		@ prow(),057  PSAY "Papel"
		@ prow(),064 PSAY "    ( )Sim ( )Não      ____/____/____    ______________________________" 
 		tmp2->(dbskip())  
 	end
	tmp2->(dbclosearea())
	tmp1->(dbskip())	
end
@ prow() +2,064 PSAY "   RECOLHIDO POR:   ______________________________    ____/____/____    " 
...
aadd(_agrpsx1,{cperg,"05","Do depto           ?","mv_ch5","C",06,0,0,"G",space(60),"mv_par05"       ,space(15)        ,space(30),space(15),space(15)        ,space(30),space(15),space(15)        ,space(30),space(15),space(15)        ,space(30),space(15),space(15)        ,space(30),"SI3"})
