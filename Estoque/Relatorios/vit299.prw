...
±±³Programa  ³ VIT299   ³ Autor ³ Alex Júnio de Miranda ³ Data ³ 19/01/08 ³±±
...
user function vit299()
nordem  :=""
tamanho :="G"
limite  :=220
titulo  :="ENTRADAS DE INSUMOS E EMBALAGENS"
...
nomeprog:="VIT299"
wnrel   :="VIT299"+Alltrim(cusername)
alinha  :={}
aordem  :={}
nlastkey:=0
...
cabec2:="CODIGO  PRODUTO                                       QUANTIDADE  UM  FORNECEDOR                               LT.FORNECEDOR      N.F.    ENTRADA  LT.VITAMEDIC FABRICANTE                       LT.FABRIC."
